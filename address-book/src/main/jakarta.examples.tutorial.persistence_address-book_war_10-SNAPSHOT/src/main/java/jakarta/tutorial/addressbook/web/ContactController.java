...
import jakarta.tutorial.addressbook.web.util.AuthenticationManager;
...
public String login() {
    ...
    Contact authenticatedUser = authenticationManager.authenticateUser(username, password);

    if (authenticatedUser != null) {
        return "showandtell";  // Navigate to showandtell.xhtml
    } else {
        return null;
    }
}
